...
$subject2 = "RD Bank Contact Form";
$body2 = "NEW REQUEST SUBMITTED FROM Account ID = $ID\n\nName: $name\n\nEmail: $email\n\nMessage: $message";
$headers2 = "From: Admin";
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          ...
          <button name='btn-send'class="flex mx-auto text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Submit</button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-purple-500">wplrdbank@gmail.com</a>
